...
const char * const BITCOIN_CONF_FILENAME = "aox.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "aox";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/aox";
#else
    // Unix
    return pathRet / ".aox";
#endif
