...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The aox Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "aox Core"
...
#define PACKAGE_BUGREPORT "https://github.com/aox-project/aox/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "aox Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "aox Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aox"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://aox.org/"
