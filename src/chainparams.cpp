...
public:
	...
	vSeeds.emplace_back("167.172.228.186");
	/*
	vSeeds.emplace_back("167.172.228.186");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.aoxtools.com");
        vSeeds.emplace_back("dnsseed.aoxpool.org");
	*/
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.aoxtools.com");
        vSeeds.emplace_back("seed-b.aox.loshan.co.uk");
