...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aox-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aox-tx [options] <hex-tx> [commands]  Update hex-encoded aox transaction\n" +
            "or:     aox-tx [options] -create [commands]   Create hex-encoded aox transaction\n" +
            "\n";
