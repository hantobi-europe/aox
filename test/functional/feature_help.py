...
"""Verify that starting aox with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aox with -h for help text")
        ...
        self.log.info("Start aox with -version for version information")
        ...
        self.log.info("Start aoxd with -fakearg to make sure it does not start")
