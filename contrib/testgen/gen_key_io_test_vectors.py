...
bech32_templates = [
  ...
  ('aox',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('aox',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('aox',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('taox',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('taox',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('taox',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('raox',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('raox',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('raox', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('taox',  17, 32, False, False, False),
  ('raox',  3,  1, False, False, False),
  ('aox',   15, 41, False, False, False),
  ('taox',  0, 16, False, False, False),
  ('raox',  0, 32, True,  False, False),
  ('aox',   0, 16, True,  False, False),
  ('taox',  0, 32, False, True,  False),
  ('raox',  0, 20, False, False, True)
]
