# Support for Output Descriptors in aox Core

Since aox Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `aox1...` for mainnet or `taox1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on aox's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing aox Core wallets, a convenience function `combo` is
