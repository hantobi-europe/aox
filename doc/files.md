...
aox.conf        | contains configuration settings for aoxd or aox-qt
aoxd.pid        | stores the process id of aoxd while running
...
debug.log           | contains debug information and general logging generated by aoxd or aox-qt
